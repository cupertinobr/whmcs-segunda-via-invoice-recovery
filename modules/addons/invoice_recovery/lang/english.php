...
$_ADDONLANG['invalid_token'] = "Invalid Request";
$_ADDONLANG['invalid_token_desc'] = "Your session expired or the request is invalid. Reload the page and try again.";
$_ADDONLANG['session_expired'] = "Session Expired";
$_ADDONLANG['session_expired_desc'] = "Please run a new search to access your invoices.";
$_ADDONLANG['unauthorized_invoice'] = "Access Denied";
$_ADDONLANG['unauthorized_invoice_desc'] = "This invoice is not available with your current access.";
$_ADDONLANG['invalid_gateway'] = "Invalid Gateway";
$_ADDONLANG['invalid_gateway_desc'] = "The selected payment method is not available.";
$_ADDONLANG['method_not_allowed'] = "Method Not Allowed";
$_ADDONLANG['method_not_allowed_desc'] = "This action must be performed through the recovery portal.";
